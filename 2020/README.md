...
The output of the jq code is generally an array with two elements corrosponsing to the answers for part 1 and 2 of the AoC challenge. Each file also asserts on the correct answers for the input files in this repository.
